...
public class FieldUtils {
    ...
    public static boolean hasErrors(
            final Arguments arguments, final TemplateResolution templateResolution, final String field) {

        final BindStatus bindStatus = 
            FieldUtils.getBindStatus(arguments, templateResolution, convertToFieldExpression(field), true);
    ...
    public static BindStatus getBindStatus(
            ...
            final String fieldExpression, final boolean allowAllFields) {
        ...
        final Expression expression = 
            StandardExpressionProcessor.parseExpression(arguments, templateResolution, fieldExpression);
